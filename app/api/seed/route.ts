  ...
  try {
    ...
    const tournament1 = await prisma.tournament.create({
      data: {
        ...
        bannerUrl: 'https://images.unsplash.com/photo-1626224583764-84786071963f?q=80&w=2000&auto=format&fit=crop',
    ...
    await prisma.tournament.create({
      data: {
        ...
        bannerUrl: 'https://images.unsplash.com/photo-1599474924187-334a4ae513ab?q=80&w=2000&auto=format&fit=crop',
